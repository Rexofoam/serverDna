...
<?php 
  ...
  if (isset($_GET['query'])) { //If user has entered search query, page has refreshed to generate new results
    ...
    $sql_approved .= " AND (UPPER(app.`app_name`) LIKE '%".$query."%') OR (UPPER(u.`full_name`) LIKE '%".$query."%')"; //Search by application name or creator
  }
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form class="navbar-form" method="GET" action="event_application_list_approved.php">
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category" id="subtitle">Click on 'View' to see the completed event page</p>
                </div>
                <div class="card-body">
