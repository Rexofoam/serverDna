...
<?php 
  ...
  if (isset($_GET['query'])) { //If user has entered search query, page has refreshed to generate new results
    ...
    $sql_created .= " AND (UPPER(`full_name`) LIKE '%".$query."%') OR (UPPER(`email`) LIKE '%".$query."%')"; //Search by username or email
  }
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form class="navbar-form" method="GET" action="user_list_unauthenticated.php">
            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category" id="subtitle">The following list consists of all registered and <b>unauthenticated</b> user accounts</p>
                </div>
                <div class="card-body">
